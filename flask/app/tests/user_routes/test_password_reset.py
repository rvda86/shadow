...
class TestPasswordReset(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.username = "user1"
        self.token, self.data = create_user(self.requester, self.email, self.password, self.username)
    ...
    def test_success_send_password_reset_link(self):
        self.requester.verify_email(self.token)
    ...
    def test_send_password_reset_link_email_not_verified(self):
        ...
        self.assertEqual(ExceptionMessages.PASSWORD_RESET_NOT_POSSIBLE, data["detail"])
    ...
    def test_password_entirely_numeric(self):
        ...
        self.assertEqual(ExceptionMessages.PASSWORD_NUMERIC, data["detail"][0]["msg"])

    def test_password_too_common(self):
        new_password = "password"
        self.requester.verify_email(self.token)

        data, status_code = self.requester.password_reset(new_password, self.token)

        self.assertEqual(422, status_code)
        self.assertEqual(ExceptionMessages.PASSWORD_TOO_COMMON, data["detail"][0]["msg"])
    ...
    def test_password_too_long(self):
        ...
        self.assertEqual(422, status_code)
        self.assertEqual(ExceptionMessages.PASSWORD_TOO_LONG, data["detail"][0]["msg"])
    ...
    def test_password_too_short(self):
        ...
        self.assertEqual(422, status_code)
        self.assertEqual(ExceptionMessages.PASSWORD_TOO_SHORT, data["detail"][0]["msg"])
