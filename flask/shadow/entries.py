...
class Topic(Entry):
    ...
    def load_journal_entries(self, user_id: str):
        entries_ids = db.retrieve_all_records_by_id(db.retrieve_journal_ids_by_topic_sql, (self.id, user_id))
        entries = []
    ...
    def load_todo_entries(self, user_id: str):
        entries_ids = db.retrieve_all_records_by_id(db.retrieve_todo_ids_by_topic_sql, (self.id, user_id))
        entries = []
        for id in entries_ids:
            entry = ToDo()
            entry.load_by_id(id[0], user_id)
